...
void rss_varbvsr_update (double betahat, double se, double sigma_beta, const double* SiRiS_snp, 
			 double* SiRiSr, double SiRiSr_snp, double logodds, double* alpha, double* mu, Size p) {
