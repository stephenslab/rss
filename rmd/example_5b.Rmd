---
title: "Example 5: Enrichment and prioritization analysis of GWAS summary statistics using RSS (Part B)"
author: Xiang Zhu
...
[`ibd2015_sumstat.mat`]: https://zenodo.org/doi/10.5281/zenodo.12636415
[`ibd2015_sumstat_path2641.mat`]: https://zenodo.org/doi/10.5281/zenodo.12636415
[`ibd2015_gsea_seed_459_path2641_squarem.mat`]: https://zenodo.org/doi/10.5281/zenodo.12636415
...
[`ibd2015_path2641_genes.mat`]: https://zenodo.org/doi/10.5281/zenodo.12636415
[`ibd2015_path2641_genes_results.mat`]: https://zenodo.org/doi/10.5281/zenodo.12636415

## Overview

This is Part B of [Example 5](example_5.html),
...
this part is more complicated than [Example 5 Part A](example_5a.html),
which is based on a relatively small simulated dataset.
It is advisable to go through [Example 5 Part A](example_5a.html) before
...
The input data file [`ibd2015_sumstat.mat`][] contains the GWAS summary statistics and LD matrix estimates.
...
In practice we are using much larger grid of hyper-parameters (because we seldom
...
<https://zenodo.org/doi/10.5281/zenodo.12636415>.
...
Similar to [Example 5 Part A](example_5a.html), we need to download and
...
Similar to [Example 5 Part A](example_5a.html),
